...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'mailqueue_mailermessage', 'reply_to',
                      self.gf('django.db.models.fields.TextField')(max_length=250,
    ...
    models = {
        ...
        u'mailqueue.mailermessage': {
            ...
            'app': ('django.db.models.fields.CharField', [], {'max_length': '250',
                                                              'blank': 'True'}),
            ...
            'last_attempt': ('django.db.models.fields.DateTimeField', [], {'null': 'True',
                                                                           'blank': 'True'}),
            'reply_to': ('django.db.models.fields.TextField', [], {'max_length': '250',
                                                                   'null': 'True',
                                                                   'blank': 'True'}),
